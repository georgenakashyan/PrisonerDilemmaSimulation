...
bfb = nx.read_edgelist(os.path.normpath(path[0] + "/BFacebook.csv"), delimiter=",", create_using = nx.Graph(), nodetype = int)
makeClusteringGraph(fb)
makeClusteringGraph(bfb)
makeClusteringGraph(gh)
#findAvgClust(bfb)
